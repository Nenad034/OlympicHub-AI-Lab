...
const GlobalHubSearch: React.FC = () => {
    ...
    // NOTE: enabledProviders intentionally excluded from deps - it's an object that changes
    // reference on every render even when values are the same, which would trigger duplicate searches.
    useEffect(() => {
    ...
    }, [selectedDestinations, checkIn, checkOut, roomAllocations, mealPlan, nationality, activeTab]);
    ...
    return (
        <div className="smart-search-container-v2 global-hub-search-v2">
            ...
            {activeTab === 'package' ? (
                ...
                <div className="flight-search-hub-wrapper animate-fade-in" style={{ marginTop: '2rem' }}>
                ...
                <div className="search-layout-wrapper" style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        ...
                        {searchMode === 'immersive' && !searchPerformed && (
                            <ImmersiveSearch
                                ...
                                onSearch={(data: ImmersiveSearchData) => {
                                    // Map immersive data to standard format to sync state
                                    const cin = new Date(data.checkIn);
                                    const cout = new Date(data.checkOut);
                                    const nightsCount = Math.ceil((cout.getTime() - cin.getTime()) / (1000 * 60 * 60 * 24)) || 7;
                                    ...
                                    <div className="params-grid">
                                        ...
                                        <div className="col-nationality param-item" style={{ position: 'relative' }}>
                                            ...
                                            {showNationalityPicker && (
                                                <div className="vertical-filters-popover animate-fade-in-up">
                                                    <div className="vertical-filter-group" style={{ maxHeight: '300px', overflowY: 'auto' }}>
                                        ...
                                        <div className="col-budget param-item">
                    ...
                    {/* RESULTS SECTION */}
                    {searchPerformed && (
                        <div className="content-workflow animate-fade-in" style={{ marginTop: '3rem', width: '100%', maxWidth: '1550px', margin: '3rem auto 0' }}>
                            <div className="filters-toolbar-v4 premium" style={{ display: 'flex', flexWrap: 'nowrap', gap: '16px', alignItems: 'center', width: '100%', padding: '0.4rem 1.25rem' }}>
