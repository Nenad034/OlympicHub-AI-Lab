...
import { orsSearchService, type OrsSearchParams } from './api/orsSearchService';
import type { HotelSearchResult, HotelSearchParams } from '../../services/providers/HotelProviderInterface' ;
