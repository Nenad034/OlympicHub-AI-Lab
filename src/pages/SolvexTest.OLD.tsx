...
import * as SolvexAuth from '../integrations/solvex/api/solvexAuthService';
import * as SolvexDict from '../integrations/solvex/api/solvexDictionaryService';
import * as SolvexSearch from '../integrations/solvex/api/solvexSearchService';
