...
const PricingIntelligence: React.FC = () => {
    ...
    const [addedItems, setAddedItems] = useState<any[]>([
        {
            ...
            status: 'active',
            pricelistTitle: 'Leto 2026 - Grcka'
        },
        {
            id: 'MOCK-002',
    ...
    const handleSavePricelist = async (activate: boolean = false) => {
        ...
        if (error) {
            ...
            alert('Greška pri cuvanju: ' + (error.message || 'Nepoznata greška'));
        } else if (data) {
            ...
            <div style={{
                ...
                {duplicateStatus.isDuplicate && !duplicateStatus.isModified && (
                    <div style={{
                        ...
                        <Info size={18} />
                        Ovo je kopija cenovnika: <strong>{duplicateStatus.originId}</strong>. Svaka promena ce kreirati novi jedinstveni cenovnik.
                    </div>
                )}
